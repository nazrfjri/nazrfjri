      ...
      >
        {infos.map((item, index) => (
          ...
          >
            ...
            <div className="neon-glow relative z-10 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-500/10 text-blue-600 transition-all duration-300 group-hover:bg-blue-500/20 group-hover:text-blue-700">
              {item.icon}
            </div>
