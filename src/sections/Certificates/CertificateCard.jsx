...
const CertificateCard = ({ certificate }) => {
  ...
  return (
    <motion.div
      ...
      className="holo-border group relative flex flex-col overflow-hidden rounded-3xl border border-white/40/60 bg-dreamy-glass backdrop-blur-xl transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_40px_rgba(37,99,235,.2)]"
    >
      {/* Inner Hover Glow */}
      ...
      {/* Image Container */}
      <div className="relative h-48 w-full shrink-0 overflow-hidden border-b border-white/40/50 bg-slate-950">
      ...
      <div className="relative z-20 flex flex-1 flex-col p-5 sm:p-6">
        <h3 className="text-[17px] font-bold leading-snug tracking-tight text-slate-900 transition-colors duration-300 group-hover:text-blue-600 sm:text-lg">
          {certificate.title}
        </h3>
        ...
        <div className="mt-auto pt-6 flex w-full items-center justify-between gap-3 overflow-hidden">
          ...
          {/* Issuer Badge */}
          <div className="flex min-w-0 shrink items-center gap-1.5 rounded-full bg-white/80 px-2.5 py-1.5 text-[11px] font-medium text-slate-700 ring-1 ring-inset ring-slate-300 transition-colors group-hover:ring-blue-500/30 sm:text-xs">
