    ...
    <div className="relative flex gap-4 md:gap-8 pb-12">
      ...
      <div className="relative flex flex-col items-center w-8 shrink-0">
        ...
        <motion.div
          ...
          className="relative z-10 flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 ring-2 ring-blue-500"
        >
      ...
      <motion.div
        ...
        whileHover={{ y: -5 }}
        className="group relative flex-1 rounded-3xl border border-white/60 bg-dreamy-glass p-8 backdrop-blur-xl transition-all duration-300 hover:border-blue-500/50 hover:bg-dreamy-glass hover:shadow-[0_0_30px_rgba(37,99,235,.15)]"
      >
        ...
        <div className="relative z-10 text-center sm:text-left">
          {/* Header Area */}
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-center sm:justify-between gap-x-4 gap-y-3 border-b border-slate-300 pb-5">
          ...
          {/* Company Area */}
          <div className="mt-5 flex justify-center sm:justify-start items-center gap-2 font-medium text-slate-700">
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-2.5 sm:justify-start">
            {item.skills.map((skill, i) => (
              <span
                key={i}
                className="rounded-lg bg-dreamy-glass px-3.5 py-1.5 text-xs font-semibold tracking-wide text-slate-700 ring-1 ring-inset ring-slate-300 transition-colors group-hover:bg-white/80 group-hover:text-slate-900 group-hover:ring-slate-600"
              >
                {skill}
              </span>
            ))}
